...
def find_excel_files_with_keyword_in_filename(directory, keyword):
    """
    ...
    for filename in os.listdir(directory):
        if filename.endswith(('.xls', '.xlsx')) and keyword.lower() in filename.lower():
...
keyword_to_search = 'Portfolio'  # Example keyword

found_files = find_excel_files_with_keyword_in_filename(directory_path, keyword_to_search)
...
matching_filenames = find_excel_files_with_keyword_in_filename(directory_path, keyword_to_search)
